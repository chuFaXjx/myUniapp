<template>
	<view>
		...
		<view class="text" v-show="isShow">
			<text class="title">新食品原料解读系利：改善记忆新原料--</text>
			<view class="detail"><text>导语：2017年5月底，国家卫计委批准顺-15-24碳溪酸（神经酸）作为新食品原料，该原料有助于改.....</text></view>
			<view><text class="time">2021-12-20</text></view>
			<view class="h"></view>
			<text class="title">英才闹了简介--</text>
			<view class="detail"><text>英才脑力顺15+24碳酸（神经酸）是由青岛国海生物制药有限公司生产的神经营养制，采用2017年.....</text></view>
			<view><text class="time">2021-12-20</text></view>
		</view>
