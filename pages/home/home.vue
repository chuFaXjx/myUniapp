<template>
	<view>
		...
		<u-navbar fixed height="80px" title="杨继洲医生集团" class="back">
			...
			<view class="u-nav-slot1" slot="right" @click="handleModle">医生集团</view>
		</u-navbar>
		<!-- 轮播图 -->
		...
		<view>
			<view class="grid-bg">
				<view class="grid-item-bg" v-for="(item, index) in dataArr" :key="index" @click="onClickItem(item, index)">
					<view class="image">{{ item.img }}</view>
		...
		<view class="photo">
			<view class="imagebox"><img src="../../static/5.png" @click="click" alt="" /></view>
			<view class="right">
		...
		<hr />
		<view class="photo">
			<view class="imagebox"><img src="../../static/6.png" @click="click" alt="" /></view>
			<view class="right">
				<text class="p1">浙江大学附属第一医院</text>
				<br />
				<text class="p2">杭州市庆春路79号</text>
