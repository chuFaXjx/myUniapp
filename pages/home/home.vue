<template>
	<view>
		...
		<view class="u-demo-block">
			...
			<view>
				<u-modal :show="show" :title="title" showCancelButton confirmColor="#ADB3AB" @confirm="confirm"
					@cancel="cancel">
		...
		<view class="font2">
			...
			<navigator url="/pages/lookmore/lookmore" hover-class="navigator-hover">
		...
		<view class="bg">
			...
			<view class="rightfont">
				<text>http://www.8111.cn/</text>
			</view>
		</view>
		<view class="bg">
			<view class="tele">
				<img src="../../static/ding.png" alt="" />
			</view>
			<view class="rightfont">
				<text>浙江省杭州市浙江大学国家科技大学园A东325室</text>
			</view>
		</view>
	</view>
</template>
			...
			return {
				...
				list: [{
					...
					},
					{
						...
						name: "star",
						title: "医生集团",
						path: "/pages/fit/group"
					},
					{
						id: 3,
						name: "hourglass",
						title: "健康处方",
						path: "/pages/fit/hourglass"
					},
					{
						id: 4,
						name: "home",
						title: "名医在线",
						path: "/pages/fit/doctor"
					},
					{
						id: 5,
						name: "star",
